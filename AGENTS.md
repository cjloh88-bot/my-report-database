...
Engineering project report tracker: engineers submit stage reports, managers review/approve/return them, with revision history and a status dashboard — all demoable without login in v1.
