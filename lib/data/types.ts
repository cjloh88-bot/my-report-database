...
export type Project = {
  ...
  status: string; user_id: string | null; created_at: string;
};

export type Stage = {
  id: string; project_id: string; name: string; order_num: number; user_id: string | null; created_at: string;
};
...
export type Report = {
  ...
  due_date: string | null; submitted_at: string | null; reviewed_at: string | null; user_id: string | null; created_at: string;
};

export type ReviewComment = {
  id: string; report_id: string; author_name: string | null; comment_text: string | null;
  action: "approve" | "return" | "comment"; user_id: string | null; created_at: string;
};

export type Revision = {
  id: string; report_id: string; revision_number: number; content: string | null;
  changed_by_name: string | null; change_summary: string | null; user_id: string | null; created_at: string;
};
